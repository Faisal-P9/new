    ...
    $(window).on("load", function () {
        setTimeout(function() {
            $(window).scroll(function () {
              ...
              var small_flower = document.getElementById('small_flower');
              var big_flower = document.getElementById('big_flower');
              ...
              planet.style.marginLeft  = value * -0.15 + 'px';
              big_island.style.marginBottom  = value * -0.15 + 'px';
              small_island.style.marginBottom  = value * -0.05 + 'px';
              ...
              grass.style.marginTop = value * -0.25 + 'px';
              sun.style.marginBottom = value * 0.35 + 'px';
              sun.style.marginLeft = value * -0.35 + 'px';
...
var flowerAni = gsap.timeline({});

flowerAni
.to('.small_flower', { duration: 2, rotation: -2, ease: 'none', delay: 10 })
.to('.small_flower', { duration: 2, rotation: 0, ease: 'none' })
.to('.small_flower', { duration: 2, rotation: -2, ease: 'none' })
.to('.small_flower', { duration: 2, rotation: 0, ease: 'none' })
...
var bigflowerAni = gsap.timeline({});

bigflowerAni
.to('.big_flower', { duration: 2, rotation: -2, ease: 'none', delay: 10 })
.to('.big_flower', { duration: 2, rotation: 0, ease: 'none' })
.to('.big_flower', { duration: 2, rotation: -2, ease: 'none' })
.to('.big_flower', { duration: 2, rotation: 0, ease: 'none' })
